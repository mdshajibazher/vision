  ...
  <h1> </h1>
    <section>
      <div class="owl-carousel owl-theme-default hero-slider owl-nav-custom">
        <!-- Hero Slide-->
        <div class="hero-slide bg-size bg-center py-5" style="background: url(<?php echo get_template_directory_uri(); ?>/img/hero-banner-1.jpg)">
        ...
        <!-- Hero Slide -->
        <div class="hero-slide bg-size bg-center py-5" style="background: url(<?php echo get_template_directory_uri(); ?>img/hero-banner-2.jpg)">
          <div class="container text-white py-5 index-forward">
            <div class="row">
              <div class="col-lg-7">
        ...
        <!-- Hero Slide -->
        <div class="hero-slide bg-size bg-center py-5" style="background: url(<?php echo get_template_directory_uri(); ?>img/hero-banner-3.jpg)">
          <div class="container text-white py-5 index-forward">
            <div class="row">
              <div class="col-lg-7">
